...
const bodyClasses = [
    ...
    "[&>ul>li>a:hover]:border-brand-black [&>ul>li>a:hover]:bg-brand-surface",
    "[&>ul>li>a[target]]:after:text-brand-gray",
...
const LinkPageTemplate = ({ meta, children }: TemplateProps) => (
    <div className="mx-auto flex max-w-md flex-col">
        <header className="order-2 text-center">
            ...
            {!!meta.description && (
                <p className="text-brand-gray mt-2 leading-7 text-pretty">
                    {meta.description}
                </p>
            )}
        </header>
